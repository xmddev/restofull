...
import { INITIAL_TABLES } from '../data/constants';
...
const TableMap: React.FC = () => {
  ...
  const getStatusColor = (status: TableStatus) => {
    switch (status) {
      case TableStatus.AVAILABLE: return 'bg-emerald-100 border-emerald-300 text-emerald-800'; 
      case TableStatus.OCCUPIED: return 'bg-red-100 border-red-300 text-red-800';
      case TableStatus.RESERVED: return 'bg-amber-100 border-amber-300 text-amber-800'; 
      case TableStatus.PAYMENT_PENDING: return 'bg-blue-100 border-blue-300 text-blue-800'; 
    }
  };
