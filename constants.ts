...
// --- 2. INGREDIENTS (UPDATED TO PORTION/UNIT BASED) ---
...
// --- 4. MENU (UPDATED RECIPES TO UNITS) ---
export const INITIAL_MENU: MenuItem[] = [
  { id: 'p-1', name: 'Hamburguesa Artesanal', description: '200g de carne angus, queso paipa, tocineta y vegetales frescos en pan brioche.', price: 32000, taxRate: 0.08, category: Category.MAIN, isAvailable: true, 
    recipe: [
      { ingredientId: 'ing-1', quantity: 1 }, // 1 Pack de Carne
      { ingredientId: 'ing-4', quantity: 1 }, // 1 Pan
      { ingredientId: 'ing-2', quantity: 2 }  // 2 Lonjas Queso
    ] 
  },
  ...
  { id: 'p-5', name: 'Volcán de Chocolate', description: 'Bizcocho de chocolate caliente con centro líquido, acompañado de helado.', price: 18000, taxRate: 0.08, category: Category.DESSERT, isAvailable: true,
    recipe: [
      { ingredientId: 'ing-7', quantity: 1 } // 1 Base Congelada
    ]
  },
...
export const INITIAL_ORDERS: Order[] = [
  { 
    ...
    status: OrderStatus.COOKING, createdAt: new Date(Date.now() - 1800000), // 30 mins ago
  ...
  { 
    ...
    status: OrderStatus.DELIVERED, createdAt: new Date(Date.now() - 3600000), // 1 hour ago
...
export const INITIAL_PROMOTIONS: Promotion[] = [
    {
        ...
        type: '2x1',
        value: 0, // Logic calculated
        activeDays: [3], // Wednesday
        targetProductIds: ['p-1'], // Hamburguesa Artesanal
        isActive: true
    },
    {
        id: 'promo-2',
